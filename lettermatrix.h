...
// os: the output stream to send the data (can be the console or 
// a text file).
...
// is: the input stream providing the letters (can be the console 
// or a text file).
...
//>> // Compares two letter matrices to see if they contain exactly the 
//>> // same letters in exactly the same locations.
